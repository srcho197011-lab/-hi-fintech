...
ADJ = {
    ...
    "startF": {                                        # 2027년 월별 개시 계수(0~1) — 2028년부터 성숙 계수 · 근거는 매출근거 시트
        ...
        "Sub": [0.08, 0.13, 0.19, 0.26, 0.33, 0.41, 0.50, 0.59, 0.68, 0.78, 0.89, 1.00],   # 1월 과금 · 연말 유료 기관 중 그 달 과금 비중
...
TIMING_KEYS = ("revMode", "matureY", "subStartYear", "careRate", "carePerCenter", "careFee", "careCostRate", "chkSeason", "startF")
...
START_NOTE = {
    ...
    "Sub": "1월 과금 · 준비기간(2026-10~12) 파일럿이 1월에 유료 전환(연말의 8%) 뒤 12월 100% — 딥카스 월 3~5곳 · 니어닥 2개월 400곳(유료 50%+) · 실손24 5개월 26% · 합계 5.84개월분",
    "Ins": "리드라우팅 설계보고서 P1 파일럿 8주(4~5월 강남 300건) → P2 12주(수도권 7개 지역단 ≈ 물량 55%) → P3 8월 말 전국 · 신규 권역 성숙 0.5/0.75/0.9/1(금융위 비교·추천 주간 추이) · 조사 계수에서 회원 증가분(m/12)을 뺀 값",
...
REV_PLAN_NOTE = {
    "sub": "1월 과금 · 연말 유료 기관 중 그 달 과금 비중 0.08→1(합 5.84개월분) · 2028~ 유형별 유료 기관 직선 경로 · 병원 50만은 선도 EMR(9만)의 5.6배 — 정액 SaaS·광고로만(환자 흐름 대가 금지)",
    "chk": "4월 개시 · 0.25→1(5개월) × 검진 계절(연말 쏠림) · 검진기관 건당 수수료 구조는 의료법 §27③ 검토 필요(조사 지적)",
    "resv": "골프·시설 예약 — 검진 예약 × 배수라 4월 개시 · 회원 기준(검진 계절 없음)",
    "ins": "4~5월 파일럿 300건 → 6~8월 수도권 7개 지역단 → 8월 말 전국 · 조사상 2027 적정 1.4만~5.5만 건(중간 3만) — 보험업법 §99① 법률의견 전제",
