...
2026-09-14 대표 지시
  ...
  · 「보험 중개 수수료」를 「헬스메이트센터 사용료」로 바꾸고 전략적 투자금에 연동한 우대 단가를 둔다(대표 지시 2026-09-14 추가).
    기준 — 투자금 80억(2026-09-17 요청액으로 통일 · 종전 100억) · DB 건당 시가 10만원 가정.
    우대 단가 — 1차연도 시가의 50%(5만원), 매년 +1만원(5→6→7→8→9만, 시가 상한).
    우대 한도 — 매년 10만 건 고정(2026-09-17 대표 지시 · 종전 10→20→30→40→50만). 한도를 넘는 공급 건은 시가.
...
ADJ = {
    ...
    "hmInvest": 8_000_000_000,                         # 전략적 투자금(우대 조건 기준) — 대표 지시 2026-09-17 요청액 80억으로 통일(종전 100억)
    "imAmt": 8_000_000_000,                            # IM 투자 금액 — 대표 지시 2026-09-17 B 요청액 80억으로 통일(IM v1.1은 100억)
    "t1Rate": 0.75,                                    # 1차 투자 비율 — 대표 지시 2026-09-17 1차 60억(10억 올림)·2차 20억, 1차만으로 버티는 기간을 9월로(종전 0.6 = 50억·7월)
    "hmMarket": 100_000,                               # DB 건당 시가
    "hmRate1": 0.50, "hmPriceStep": 0,                 # 우대 단가 5만 고정(대표 지시 2026-09-16) — 시가×50%, 매년 인상 없음
    "hmCap1": 100_000, "hmCapStep": 0,                 # 우대 한도 매년 10만 건 고정(대표 지시 2026-09-17 — 종전 매년 +10만) · 나머지는 시가 10만
    ...
    "prodAdjY1": 0.70,
    # 대표 지시 2026-09-17 — 병원·약국 월 구독료는 2028년부터 과금(2027 무료, 검진센터와 같음) · 약국 제휴 수는 전 연도 절반
    "subStartYear": {"centers": 2, "hospitals": 2, "pharmacies": 2},
    "pharmacies": [100, 1_000, 2_000, 4_000, 6_000],   # 종전 200 · 2,000 · 4,000 · 8,000 · 12,000
    # 대표 지시 2026-09-17 — 제휴마케팅: (주)인피니티케어 MOU 체결(약 300개 건강검진센터·검진병원 제휴, 연 약 15만 명 건강검진 연계)
    # 2027 신규 가입 33만 중 15만 명은 인피니티케어 연계 → 메디에이지 리포트 구매에서 뺀다(costs.medi_report · 33만 → 18만 건)
    "infinityVolume": 150_000, "infinityCenters": 300,
...
def apply(P):
    Q = copy.deepcopy(P)
    Q["pharmacies"] = list(ADJ["pharmacies"])          # 대표 지시 2026-09-17 — 종전(1차 200 · 2~5차 모델값)의 절반
    Q["infinityVolume"], Q["infinityCenters"] = ADJ["infinityVolume"], ADJ["infinityCenters"]
...
START_NOTE = {
    ...
    "Sub": "대표 지시 2026-09-17로 병원·약국 과금이 2028부터라 2027 구독 매출은 0(이 계수는 쓰이지 않음) · 종전: 3월 과금 개시(대표 지시 2026-09-16 — 종전 1월) · 준비기간(2026-10~12) 파일럿이 3월에 유료 전환(연말의 8%) 뒤 12월 100% — 딥카스 월 3~5곳 · 니어닥 2개월 400곳(유료 50%+) · 실손24 5개월 26% · 합계 4.87개월분(종전 5.84)",
...
REV_PLAN_NOTE = {
    "sub": "2028 과금 개시(대표 지시 2026-09-17 — 병원·약국·검진센터 모두 2027 무료) · 종전 3월 과금 개시(대표 지시 2026-09-16) · 연말 유료 기관 중 그 달 과금 비중 0.08→1(합 4.87개월분) · 2028~ 유형별 유료 기관 직선 경로 · 병원 50만은 선도 EMR(9만)의 5.6배 — 정액 SaaS·광고로만(환자 흐름 대가 금지)",
