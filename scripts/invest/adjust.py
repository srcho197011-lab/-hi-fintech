...
ADJ = {
    ...
    "subFeeStepT": {"centers": 500000, "hospitals": 500000, "pharmacies": 500000},
}
...
def fee(P, t, y):
    """유형 t의 y(0부터) 연차 월 구독료 — 1차 0원, 2차부터 기본+인상폭×(연차−2), 상한"""
    if y == 0:
        return 0
    return min(P["subFeeCap"], P["subFeeBaseT"][t] + P["subFeeStepT"][t] * (y - 1))
