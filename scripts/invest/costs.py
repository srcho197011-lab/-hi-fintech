# -*- coding: utf-8 -*-
"""판관비·CAPEX 근거 모델(투자금 양식 v2.0) — 엑셀 생성기(gen_budget.py)와 정답지(oracle.py·oracle3.py)가 같이 읽는 단일 소스.
...
_BASE = {"checkup": 44_000_000, "clinic": 41_000_000, "care": 36_000_000, "ins": 42_400_000, "nutri": 43_000_000, "skin": 43_000_000,
         "device": 48_000_000, "sports": 40_000_000, "finance": 60_000_000, "cto": 120_000_000, "ceo": 84_000_000}
...
NOTE.update({
    "sal_checkup": "비용근거 salary_checkup — 리드 5,000만+담당 3,800만 평균 · 워크피디아 간호사(5~29명)·사람인 · 검증 확인",
    ...
    "sal_ins": "salary_ins — 팀장 6,000만 + 담당 4명 3,800만 평균 · 사람인 손해사정사·보험심사 · 확인",
    ...
    "sal_ceo": "salary_ceo — 공식 통계 없음 · 워크피디아 전문서비스 관리직(5~29명) 대비 보수적 · 신뢰도 낮음",
