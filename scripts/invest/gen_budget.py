...
put("infVol", "제휴마케팅 — (주)인피니티케어 연간 건강검진 연계 인원", "명/년", P["infinityVolume"], F_CNT, "대표 지시 2026-09-17 — 약 300개 건강검진센터·검진병원과 제휴해 매년 약 15만 명을 건강검진에 연계 중 · 제휴 = 연 15만 명 회원 모집 효과 · 인피니티케어 시스템 활용으로 회원 모집·동의 DB 생성·공급을 앞당김 · 검진 연계 타사 제휴 채널(④ 절)·회원확보 ③ 안내업체 제휴 엔진의 기반 · 참고 지표(산식 연결 없음) · 공개 자료로는 300곳·15만 명 미확인(회사 소개상 기업 건강검진 대행·검진 예약 플랫폼 운영사) — 제휴 기관 목록·연계 실적 확인서 확보 권장", False, grp="제휴마케팅")
put("infCenters", "제휴마케팅 — (주)인피니티케어 제휴 건강검진센터·검진병원", "곳", P["infinityCenters"], F_CNT, "대표 지시 2026-09-17 — 약 300곳 · 참고 지표")
