...
put("pharmacies", "약국(연말)", "곳", P["pharmacies"], F_CNT, "대표 지시 2026-09-17 — 종전(1차 200곳 · 2~5차 모델값 2,000·4,000·8,000·12,000곳)의 절반 · 5차 6,000곳 = 전국 약국 23,697곳(2024-12)의 약 25%")
put("subBase_c", "구독료 — 검진센터 월 기본(개시~2028)", "원/월", P["subFeeBaseT"]["centers"], F_WON, "대표 지시 2026-09-14 · 검진센터는 2027 무료(시장 선점) · 인상은 2029부터", True)
put("subBase_h", "구독료 — 병원 월 기본(개시~2028)", "원/월", P["subFeeBaseT"]["hospitals"], F_WON, "대표 지시 2026-09-14 · 대표 지시 2026-09-17: 병원·약국 구독 과금은 2028부터(2027 무료) · 인상은 2029부터", True)
put("subBase_p", "구독료 — 약국 월 기본(개시~2028)", "원/월", P["subFeeBaseT"]["pharmacies"], F_WON, "대표 지시 2026-09-14 · 2028부터 과금(대표 지시 2026-09-17 — 종전 2027) · 20% 복리 인상은 2029부터", True)
...
put("subStart_h", "구독 개시 연차 — 병원", "연차", P["subStartYear"]["hospitals"], "0", "2 — 대표 지시 2026-09-17 병원 월 구독료 2028부터(종전 1 = 2027) · 환자 소개 대가는 의료법 §27③ 금지라 정액 구독 구조", True)
put("subStart_p", "구독 개시 연차 — 약국", "연차", P["subStartYear"]["pharmacies"], "0", "2 — 대표 지시 2026-09-17 약국 월 구독료 2028부터(종전 1 = 2027)", True)
...
put("insConv", "동의 DB 연간 공급 집행률(계약 전환율 아님)", "%", P["insConvRate"], F_PCT,
    "형 확정 2026-08-20 · 누적 동의 전체에 매년 적용 = 기존 동의자 재공급 전제(5년 786만 건 > 누적 동의 630만) · 하락 폭이 가장 불확실한 변수 — v3.0 기본값에서 집행률 −20%는 필요 총자금 A +3.4 · B +6.9억(급여 +20%는 +4.3~6.0억, 광고 단가 전체 +20%는 +6.5~11.9억) · 2027은 공급 계획 12만 건 전량 반영(대표 지시 2026-09-16 · 조사 적정 1.4만~5.5만) · 검증보고서 v1.1 B3 라벨 권고 반영", True)
put("hmInvest", "전략적 투자금(현대해상 · 우대 조건 기준)", "원", P["hmInvest"], F_WON, "대표 지시 2026-09-17 — 요청액 80억으로 통일(종전 100억) · 대표 지시 2026-09-14 — 투자금에 맞춰 아래 우대 단가·한도를 손으로 조절(자동 연동 없음) · 투자금 대비 할인 배수 산출에 쓰임", True)
...
put("hmCap1", "우대 한도 — 2027(1차)", "건", P["hmCap1"], F_CNT, "연 10만 건 — A는 달력 연도(2027-01~12), B·C는 오픈 기준 연차(2027-03~2028-02) · 2027 공급 12만 건 중 2만 건은 시가", True)
put("hmCapStep", "우대 한도 — 연 증가", "건", P["hmCapStep"], F_CNT, "0 — 대표 지시 2026-09-17 매년 10만 건 고정(종전 +10만 건) · 한도는 연도마다 새로 시작, 연내 누적 순서대로 적용 · 초과분 시가")


gap("⑤-2 매출 개시 일정 — 2027년 월별 개시 계수(0~1) · 검진 계절 지수 · 매출 산정 방식(대표 지시 2026-09-15 · 매출근거 시트)")
put("prodAdjY1", "2027 제품판매 기간 보정(반영률 배수)", "배", P.get("prodAdjY1", 1.0), "0.00",
    "대표 지시 2026-09-16 — 초년도 건강커머스는 실제 가동 기간을 고려해 보수적으로 30% 감액(0.70). 매출에 비례하는 제품 원가·결제 수수료·적립·기부도 함께 줄고, 광고비 등 고정성 비용은 그대로", True)
...
put("infVol", "제휴마케팅 — (주)인피니티케어 연간 건강검진 연계 인원(가입 경유)", "명/년", P["infinityVolume"], F_CNT, "대표 지시 2026-09-17 — MOU 체결 · 약 300개 건강검진센터·검진병원과 제휴해 매년 약 15만 명을 건강검진에 연계 중 · 2027 신규 가입 33만 중 15만 명을 인피니티케어 연계로 보고 메디에이지 리포트 구매(⑩-2)에서 뺌(33만 → 18만 건) · 회원 수에는 별도 가산 없음 · 인피니티케어 시스템 활용으로 회원 모집·동의 DB 생성·공급을 앞당김 · 검진 연계 타사 제휴 채널(④ 절)·회원확보 ③ 안내업체 제휴 엔진의 기반 · 공개 자료로는 300곳·15만 명 미확인 — 제휴 기관 목록·연계 실적 확인서 확보 권장", True, grp="제휴마케팅")
put("infCenters", "제휴마케팅 — (주)인피니티케어 제휴 건강검진센터·검진병원", "곳", P["infinityCenters"], F_CNT, "대표 지시 2026-09-17 — MOU 체결 · 약 300곳(회사 제시) · 참고 지표(기관 수는 산식 연결 없음)")
...
put("mk2Impr", "② 9채널 타겟 광고 — 1차 월 노출", "회/월", C2["mk2Impr"], F_CNT, "사업계획서 v12.1 p5 — 일 100만 · 월 3,000만 노출 · 대표 지시 2026-09-17: 광고비는 전액 반영하되 광고로 모집되는 회원은 회원 목표(①)에 가산하지 않음 — 목표 초과(+) 요소", True)
...
put("mediYears", "리포트를 사주는 연차", "차", C2["mediYears"], "0", "대표 지시 2026-09-16 — 1 = 초년도(2027) 가입분까지만 구매(2026-09-17: 33만 중 인피니티케어 연계 15만을 뺀 18만 건) · 이후 연차는 0", True)
put("mediShare", "가입 회원 중 제휴 DB 경유 비율(인피니티케어 연계 제외분 대비)", "%", C2["mediShare"], F_PCT, "대표 지시 2026-09-17 — 인피니티케어 연계(가정 ⑥ 제휴마케팅)를 뺀 나머지 가입 회원 전량을 메디에이지 DB 경유로 본 값")
cell(A, f"I{r}", "구매 건수 = MIN(구매 연차 안의 (총가입 − 인피니티케어 연계)×경유 비율×회원당 리포트, 그때까지 확보한 누적 DB − 이미 산 건수) · 비용은 판관비(현금은 발생 월)", SUB)
r += 1
...
def _medi_n(i):
    ...
    want = f"IF({i + 1}>{ASCALAR('mediYears')},0,ROUND(MAX(0,{yv('gross_new', i)}-{ASCALAR('infVol')})*{ASCALAR('mediShare')}*{ASCALAR('mediPer')},0))"
    return f"=MIN({want},MAX(0,{_medi_cum(i)}-{prev}))"


yline("mediN", "메디에이지 리포트 구매 건수(가입 전환분)", _medi_n, F_CNT,
      "MIN((총가입 − 인피니티케어 연계)×경유 비율×회원당 리포트, 누적 확보 DB − 이미 산 건수) — 가정 ⑥ 제휴마케팅 · ⑩-2", grp="제휴 DB")
...
for sk_, sl_, sb_ in STREAMS:
    for i in range(5):
        ...
        if sk_ == "P" and i == 0:                         # 2027 제품판매 기간 보정(대표 지시 — 보수적 30% 감액)
            base_ = f"({base_})*{ASCALAR('prodAdjY1')}"
...
levers = [
    ...
    ("lagSub", "회수 지연 — AI 플랫폼 구독", [1, 1, 1], "개월", "기관 후불 청구 — 다음 달 입금(AI 플랫폼 구독 2028-01 과금 → 2028-02 첫 입금 · 2027 무료)", "0", False),
...
for k, lab, v, unit, note, fmt in [("startMonth", "준비 시작 월(인건비·광고·시스템 설치 개시)", datetime(2026, 10, 1), "월", "대표 일정 2026-09-15 — 2026-10 본격 준비 · 2027-01-01 오픈 · AI 플랫폼 구독 2028-01(2027 무료 — 대표 지시 2026-09-17) · 검진·사용료 04부터 서서히 · 커머스·돌봄 07부터", "yyyy-mm"),
                                   ("closeDate", "클로징 기준일", "입력", "", "투자금은 준비 첫 달(2026-10) 전에 들어와야 한다 — 첫 달에 시스템 설치 선급 · 일회성 비용이 나간다", None),
                                   ("imAmt", "IM에 적힌 투자 금액", adjust.ADJ.get("imAmt", 10000000000), "원", "대표 지시 2026-09-17 — B 요청액 80억으로 통일(HI-Fin_현대해상_IM v1.1의 100억은 문서 수정 필요) · 요청액과 다르면 경고(전략적 투자금은 가정 ⑤)", F_WON)]:
    cell(C, f"B{cr}", lab)
...
cell(FT, "A2", '="선택 기준: "&CHOOSE($C$4,"A 계획","B 보수","C 게이트 지연")&" · 준비 시작 "&TEXT(' + _SM + ',"yyyy-mm")&" · 오픈 "&TEXT(EDATE(' + _SM + ',CHOOSE($C$4,\'현금·투자금\'!$C$' + str(CR['pre']) + ',\'현금·투자금\'!$D$' + str(CR['pre']) + ',\'현금·투자금\'!$E$' + str(CR['pre']) + ')),"yyyy-mm")&" · 대표 일정(A): AI 플랫폼 구독 2028-01(2027 무료) · 건강검진·헬스메이트센터 사용료 2027-04부터 서서히 · 건강커머스·재가돌봄 2027-07부터 · 단위 백만원"', SUB)
...
fr += 1
frow("rSub", "AI 플랫폼 구독(검진센터·병원·약국 2028~ · 2027 무료)", ["rSub"], grp="매출 발생")
...
cell(T, f"B{tr}", "T1 비율"); cell(T, f"C{tr}", adjust.ADJ.get("t1Rate", 0.6), BLUE, F_PCT, YELLOW); TR["t1r"] = tr
cell(T, f"D{tr}", "대표 지시 2026-09-17 — 1차 60억·2차 20억(종전 60% = 50억, 1차만으로 2027-07 소진)", SUB); tr += 1
...
for ms in ["헬스메이트센터 DB 공급 파일럿 Go 판정 — 응답 80% · 상담 40% · 청약 8%(리드라우팅 설계보고서 §5.4)",
           ...
           "AI 플랫폼 제휴 기관(검진센터·병원·약국) 확보 — 목표 기관 수 입력(2027 무료 운영)"]:
...
scr_rev = [("제품판매 매출 · 건강쇼핑(GMV)", 4737000, ["revP"], "v3.0 — 2027-07 개시 · 월말 회원 기준 월별 누적(화면 시뮬은 가동률 33%)"),
           ...
           ("EMR-UIP 사용료", 0, ["revSub"], "v3.7 — 병원·약국·검진센터 모두 2028-01부터 과금(2027 무료 — 대표 지시 2026-09-17) · 화면 시뮬도 1차 무료"),
...
REV_LINES = [("Sub", "AI 플랫폼 구독(검진센터·병원·약국 2028~ · 2027 무료)", "revSub", "fullSub", "다음 달", "sub"),
...
for t_ in ["사업 일정(대표 지시 2026-09-15) — 2026-10 본격 준비(인건비·광고·시스템 설치·메디에이지) → 2027-01-01 오픈 → AI 플랫폼 구독 2028-01부터(2027 무료 — 대표 지시 2026-09-17) · 건강검진 연계·헬스메이트센터 사용료 2027-04부터 서서히 · 건강커머스·재가돌봄 2027-07부터. 연차 = 달력 연도(1차 2027 ~ 5차 2031). 입금은 기관·검진·돌봄 다음 달, 커머스는 카드·PG라 같은 달.",
...
for t_ in [
    ...
    "5. 헬스메이트센터 사용료는 원가가 없어 이익에 그대로 반영된다. 2027 공급 12만 건 전량 반영(대표 지시 2026-09-16) = 우대 10만×5만 + 시가 2만×10만 = 70억 · 조사상 2027 적정 1.4만~5.5만 건(중간 3만). 우대 한도는 매년 10만 건 고정(대표 지시 2026-09-17)이라 2028 23.4만 건 = 우대 10만×5만 + 시가 13.4만×10만 = 184.2억. 한도 초과분이 시가 10만이라 모델(건당 7만)보다 크다 — 시가 10만의 근거를 첨부할 것(조사: 동의 DB 시장 5만~13만 · 상담 일정 확정 DB 15만~20만). ⚠ 명칭을 사용료로 바꿔도 보험업법 §99①(모집 대가) 위험은 그대로 — 유료 공급 전 법률의견 또는 GA 경로.",
