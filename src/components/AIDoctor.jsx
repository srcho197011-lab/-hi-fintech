...
const DZ_DEEP = {
  "뇌졸중": { drug: "급성기 혈전용해제(4.5시간 내)·혈전제거술, 예방 항혈소판제·항응고제(심방세동)", comp: ["편마비·언어·삼킴 장애", "혈관성 치매", "재발·낙상"], red: ["갑자기 한쪽 마비·발음 어눌·시야장애·심한 두통·어지럼 → 즉시 119(골든타임 4.5시간)"] },
  "파킨슨병": { drug: "레보도파·도파민효능제·MAO-B억제제 등", comp: ["보행장애·낙상·연하곤란", "후기 인지저하", "기립성저혈압"], red: ["갑작스런 삼킴장애·심한 낙상·의식변화 → 진료"] },
  "알츠하이머·치매": { drug: "콜린분해효소억제제(도네페질 등)·메만틴", comp: ["일상생활 수행 저하", "배회·낙상·영양불량", "동반 우울"], red: ["급격한 인지저하·발열·탈수 동반(섬망) → 진료"] },
  "고혈압": { drug: "ARB/ACE억제제·칼슘차단제·이뇨제 등", comp: ["뇌졸중·심근경색·심부전", "신부전·망막병증"], red: ["수축기 180↑ + 심한 두통·흉통·시야장애·신경증상 → 응급(고혈압 위기)"] },
  "협심증": { drug: "항혈소판제(아스피린)·스타틴·베타차단제·설하 니트로글리세린", comp: ["심근경색·심부전·부정맥"], red: ["20분 이상 지속되는 가슴 압박·식은땀·왼팔/턱 방사통·호흡곤란 → 즉시 119"] },
  "부정맥": { drug: "심박수조절제·항부정맥제, 심방세동은 항응고제(뇌졸중 예방)", comp: ["뇌졸중(심방세동)", "심부전"], red: ["실신·심한 어지럼·흉통 동반 두근거림 → 응급"] },
  "당뇨병": { drug: "메트포르민·SGLT2억제제·GLP-1·인슐린 등", comp: ["망막·신장·신경병증", "심혈관질환·당뇨발"], red: ["고혈당(의식저하·심한 갈증·구토) 또는 저혈당(식은땀·떨림·의식저하) → 응급"] },
  "갑상선기능항진증": { drug: "항갑상선제(메티마졸)·베타차단제·방사성요오드", comp: ["갑상선중독발작", "심방세동·골다공증"], red: ["고열·심한 빈맥·의식저하(갑상선중독발작) → 즉시 응급"] },
  "만성콩팥병": { drug: "ARB/ACE억제제·SGLT2억제제(신장보호)·빈혈/인 관리제", comp: ["말기신부전(투석)", "심혈관질환·빈혈·골질환"], red: ["소변량 급감·심한 부종·호흡곤란·고칼륨(부정맥) → 응급"] },
  "천식": { drug: "흡입 스테로이드(조절제)·속효성 기관지확장제(완화제)", comp: ["급성 악화·호흡부전"], red: ["완화제에 반응 없는 심한 호흡곤란·말하기 힘듦·입술 청색 → 즉시 119"] },
  "COPD": { drug: "흡입 기관지확장제(LAMA/LABA)·흡입스테로이드", comp: ["급성악화·호흡부전·폐성심"], red: ["급격한 호흡곤란 악화·의식저하·청색증 → 응급"] },
  "폐렴": { drug: "원인균 맞춤 항생제·해열제", comp: ["패혈증·호흡부전·흉막염"], red: ["고열 지속·호흡곤란·의식저하·산소포화도 저하 → 응급"] },
  "위·십이지장궤양": { drug: "PPI(위산억제제)·H.pylori 제균 항생제", comp: ["출혈·천공·유문협착"], red: ["토혈·흑색변·심한 복통(천공 의심) → 즉시 응급"] },
  "요로결석": { drug: "진통제·요관확장(알파차단제)·필요 시 체외충격파쇄석", comp: ["수신증·요로감염·신기능 저하"], red: ["극심한 통증 + 고열·오한(감염 동반) → 즉시 응급"] },
  "통풍": { drug: "급성기 NSAID/콜히친/스테로이드, 예방 요산강하제(알로푸리놀 등)", comp: ["만성 통풍결절·관절변형", "신결석·신장병"], red: ["관절 발열·전신 고열(감염성 관절염 감별) → 진료"] },
  "대상포진": { drug: "항바이러스제(72시간 내)·진통제(신경통)", comp: ["대상포진후신경통", "눈·귀 침범"], red: ["눈 주변 발진·시력변화 → 즉시 안과(실명 위험)"] },
  "우울증": { drug: "SSRI 등 항우울제(효과까지 2~4주)", comp: ["자살·자해", "기능저하·만성화"], red: ["자살 생각·자해 충동 → 즉시 자살예방상담 1393·응급실"] },
  "공황장애": { drug: "SSRI·필요 시 단기 항불안제", comp: ["광장공포증·회피", "우울 동반"], red: ["흉통·호흡곤란이 심장질환과 감별 안 되면 → 응급 평가"] },
  "결핵": { drug: "표준 4제 병합요법(최소 6개월, 끝까지 복용)", comp: ["파종성 결핵·재발", "내성결핵"], red: ["대량 객혈·심한 호흡곤란 → 응급"] },
  "백혈병": { drug: "항암화학요법·표적치료·조혈모세포이식", comp: ["감염(호중구감소)·출혈·빈혈"], red: ["고열·심한 출혈·의식저하 → 즉시 응급"] },
  "두드러기": { drug: "항히스타민제, 중증(아나필락시스)은 에피네프린", comp: ["만성 두드러기", "아나필락시스"], red: ["입술/혀 부종·호흡곤란·어지럼(아나필락시스) → 즉시 에피네프린·119"] },
...
function deepCards(name) {
  const d = DZ_DEEP[name]; if (!d) return [];
  const out = [];
