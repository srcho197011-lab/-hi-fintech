...
const DATA_CONNECTORS = [
  { id: "mcp-josungrae", name: "조성래 검진 리소스 (실데이터)", org: "HI-Fin MCP · 로컬 브리지", kind: "MCP", cat: "MCP", icon: "database", featured: true,
    desc: "조성래 실측 검진데이터(국가검진·종합검진·프롬에이지 리포트)를 MCP 리소스로 실제 fetch합니다.",
    ep: "./src/data/mcp_josungrae.json", auth: "MCP 토큰 + 본인 동의(DID)", fields: ["get_member_checkup", "national", "comprehensive", "report"] },
