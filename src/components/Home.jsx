...
const STORY_SCENES = [
  ...
  { era: "5월", title: "민석의 숫자", c: "#16A34A",
    ...
    links: [["나의 건강현황 — 생체나이·위험 리포트", "manage"], ["보험·치료비 — 보장 공백 3분 점검", "insurance"], ["건강쇼핑 — 성적표로 고르는 소비", "shop"]] },
  ...
  { era: "10년 후", title: "수술 동의서 앞에서", c: "#EF4444",
    text: ["64세. 정기검진이 심장 혈관의 협착을 찾아냈습니다. 시술이 필요했습니다. 수술 동의서 앞에 앉은 조 씨는 문득 깨달았습니다 — 비용 항목을 한 번도 걱정하지 않았다는 것을.", "진단비 보험금이 나왔고, 10년간 잠겨 있던 보험·치료비 적립금이 본인부담을 덮었습니다. 민석의 가족이 아파트를 줄이며 치렀던 그 비용을, 그는 서명 한 번으로 지나갔습니다. 시술은 성공했습니다 — 조기 발견이었으니까.", "지갑에는 1~4세대 데이터 자산 수십 개가 계보로 쌓여 매년 배당을 낳고, 당뇨는 10년째 '전단계'에서 멈춰 있고, 보험료는 성과 증명마다 내려갔습니다. 건강관리가 지출이 아니라 재산증식이었습니다. 노모는 원격 모니터링과 재가돌봄 속에서 존엄하게 아흔을 넘겼습니다."],
    links: [["보험·치료비 — 치료비 걱정 ZERO 구조", "insurance"]] },
