...
import {
  ...
  Download, Trash2, Pencil, Droplet,
} from "lucide-react";
...
function SecIcon({ k }) {
  ...
  switch (k) {
    ...
    case "ontology": return (<svg {...S}><defs>
      ...
      <Sh rx={11} />
      <g stroke="#7DD3FC" strokeWidth="1.8"><line x1="24" y1="16" x2="13" y2="30" /><line x1="24" y1="16" x2="35" y2="30" /><line x1="13" y1="30" x2="35" y2="30" /><line x1="24" y1="16" x2="24" y2="34" /></g>
    ...
    case "social": return (<svg {...S}><defs>
      <linearGradient id="i-soc-r" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stopColor="#FF9DB0" /><stop offset="1" stopColor="#E11D48" /></linearGradient>
      <linearGradient id="i-soc-h" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stopColor="#5EEAD4" /><stop offset="1" stopColor="#0D9488" /></linearGradient>
      <radialGradient id="i-soc-gl" cx="50%" cy="40%" r="55%"><stop offset="0" stopColor="#FDA4AF" stopOpacity=".5" /><stop offset="1" stopColor="#FDA4AF" stopOpacity="0" /></radialGradient></defs>
      <Sh rx={12} />
      <circle cx="24" cy="20" r="16" fill="url(#i-soc-gl)" />
      <path d="M9.5 27.5c-1.7 0-2.9 1.7-2.2 3.2C9.1 35.3 15.8 38.5 24 38.5s14.9-3.2 16.7-7.8c.7-1.5-.5-3.2-2.2-3.2-.9 0-1.8.6-2.2 1.4-2 3.4-6.8 5.6-12.3 5.6s-10.3-2.2-12.3-5.6c-.4-.8-1.3-1.4-2.2-1.4z" fill="url(#i-soc-h)" />
      <path d="M24 11c-2.7-3.9-9-2.7-9 2.5 0 3.8 4.3 6.8 9 10.3 4.7-3.5 9-6.5 9-10.3 0-5.2-6.3-6.4-9-2.5z" fill="url(#i-soc-r)" />
      <path d="M20 15.2c.4-1.1 1.1-1.8 2.2-2.2-1.1-.4-1.8-1.1-2.2-2.2-.4 1.1-1.1 1.8-2.2 2.2 1.1.4 1.8 1.1 2.2 2.2z" fill="#fff" opacity=".9" />
      <circle cx="15" cy="30.6" r="1.6" fill="#fff" opacity=".92" /><circle cx="33" cy="30.6" r="1.6" fill="#fff" opacity=".92" /></svg>);
...
const SECTIONS = [
  ...
  { k: "insurance", ic: ShieldCheck, t: "치료비 케어", s: "조회·가입·청구·치료비" },
