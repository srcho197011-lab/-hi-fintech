...
const AGENT_SEC_GUIDES = [
  { k: "checkup", label: "건강검진 예약", words: ["검진예약", "건강검진", "검진센터", "검진받", "검진신청", "검진잡", "검진하러", "검진받고싶", "검진받으려", "국가검진", "종합검진", "검진현황", "예약현황"], guide: "건강검진 예약 화면을 안내해 드릴게요. 전국 제휴 검진센터를 지역·항목·가격으로 비교해 원하는 날짜에 예약하실 수 있어요. 하이핀을 통해 예약하고 검진을 받으시면 무료 3종 서비스(검진대비보험 0원 · AI 정밀리포트 · 전문가 상담)가 함께 제공돼요.", btns: ["내 주변 검진센터 찾아줘", "무료 3종이 뭐예요?", "어떤 검진 받아야 해?"] },
  ...
  { k: "insurance", label: "보험·치료비", words: ["보험섹션", "보험화면", "보험보", "보험부족", "보장부족", "보험열어", "보장조회", "보험가입", "치료비화면", "보험쪽", "보험메뉴"], guide: "보험·치료비 화면을 안내해 드릴게요. 보장조회 → AI 보험솔루션(보장공백·본인부담) → 간편가입 → 보험금 청구까지 한 곳에서 돼요. 제 데이터 기준 분석은 말만 하시면 바로 해드려요.", btns: ["보장 공백 분석", "내 실손 몇 세대야?", "보험금 청구 어떻게 해?"] },
  { k: "wallet", label: "건강금융지갑", words: ["건강지갑", "금융지갑", "지갑보", "적립금보", "혜택보여", "지갑열", "적립현황", "적립내역", "온체인", "토큰지갑"], guide: "건강금융지갑을 열어드릴게요. HTK 적립 현황과 보험·치료비 전용 적립(30% 우선), 나눔·기부, 온체인 원장(전송·스왑)까지 볼 수 있어요.", btns: ["적립금 얼마 쌓였어?", "토큰 전송하는 법"] },
