...
const AGENT_SEC_GUIDES = [
  ...
  { k: "home", label: "회사 소개", words: ["회사소개보", "소개화면", "비전보여", "하이핀이란"], guide: "HI-Fin Tech 소개 화면이에요. 회사 비전·사회적 가치환원·커뮤니티를 볼 수 있어요.", btns: ["하이핀이 뭘 해주는 곳이야?"] },
...
const AGENT_NAV_LABEL = { story: "활용 스토리", home: "회사 소개", checkup: "건강검진 예약", care: "검진 후 케어", insurance: "보험·치료비", mywallet: "나의 건강지갑", partner: "제휴·투자", onboarding: "데이터 연결", ontology: "온톨로지", shop: "건강쇼핑", ai: "AI 주치의 상담", manage: "내 건강현황", hospital: "병원진료 안내", homecare: "재가돌봄", wallet: "건강금융지갑", nft: "Health NFT", mypage: "우리가족건강관리", social: "사회적기업", community: "커뮤니티" };
