...
const AGENT_SEC_GUIDES = [
  { k: "checkup", label: "건강검진 예약", words: ["검진예약", "건강검진", "검진센터", "검진받", "검진신청", "검진잡", "검진하러", "검진받고싶", "검진받으려", "국가검진", "종합검진", "검진현황", "예약현황"], guide: "건강검진 예약 화면을 안내해 드릴게요. 내 주변 검진센터를 비교해 예약하면 무료 검진대비보험이 자동으로 붙고, 결과 조회·사후관리까지 이어져요. 화면에서 지역·항목을 고르셔도 되고, 저한테 '내 주변 검진센터 찾아줘'라고 하셔도 돼요.", btns: ["내 주변 검진센터 찾아줘", "무료 보험이 뭐예요?", "어떤 검진 받아야 해?"] },
