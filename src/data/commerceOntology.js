...
const COMM_DISEASE = [
  ...
  { dz: "관절염", label: "관절·연골 건강", kw: ["관절", "무릎", "연골", "골관절염", "퇴행성관절", "류마티스", "오십견", "어깨통증"], areas: ["관절", "통증"], devProducts: ["관절재활통증기기", "고주파 리페어", "바디닥터"], vendors: ["GN바디닥터", "안국약품", "조윈", "세라젬"], note: "관절·연골 건강과 가정용 통증·온열 케어" },
  { dz: "요실금", label: "요실금·배뇨 건강", kw: ["요실금", "방광", "배뇨", "실금", "소변", "빈뇨", "야뇨"], areas: ["요로", "전립선"], devProducts: ["여성 웰니스 케어기기"], vendors: ["GN바디닥터"], note: "요로·배뇨 건강과 가정용 요실금 케어" },
...
function _catOverview(kind, kb) {
  ...
  ], quicks: kind === "홈케어의료기" ? ["당뇨 혈당측정기 추천", "여성 웰니스 케어기기 알려줘", "🛒 홈케어 기기 보기"] : ["관절 영양제 추천", "면역 영양제 추천", "🛒 건강쇼핑에서 성분·제품 보기"] };
}
...
function commerceCounsel(text) {
  ...
  // 1) 제품 정확(전체 이름) 매칭 우선 — 예: "여성 웰니스 케어기기", "락토핏 골드"
