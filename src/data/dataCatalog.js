...
const HIFIN_KEY_GROUPS = [
  ...
  { g: "ops", ko: "계측·운영", pats: ["hifin_events", "hifin_telem", "hifin_wp_log", "hifin_lead", "hifin_handoff_", "hifin_hm_", "hifin_nodes", "hifin_ocr"], sensitive: "낮음(경량 식별자만)" },
