...
const HM_STAGE_GUIDE = {
  ...
  D2: { entry: "실측 검진값이 데이터 금고에 저장(1세대 자산)",
    doKo: "첫 연결의 골든타임 — 한 통화에 다섯 가지를 전해요: ①무료 3종 안내 ②보험 혜택·적용법(0원 기가입) ③리포트 예고 ④맞춤 케어 키트 안내(결과 기반 영양소·기기 무료) ⑤향후 지원 약속. 전달 체크 5칸이 ⑩관제탑에 집계돼요(대본: ⭐ 첫 연결 파트).",
  ...
  D3: { entry: "등급·위험도·예측 리포트 생성(2세대 자산)",
    doKo: "예측 해설과 보장분석 대화 — 숫자가 아니라 '무엇을 하면 되는지'로 번역해 주는 게 프로의 일이에요.",
