  ...
  },
  {
    ...
    sarg: function (s) {
      return {
        ...
        route: "예약을 바꾸셔야 하면 예약하신 기관에 연락해 주세요 — 마감 시점이 기관마다 달라요. 앱에서 바로 바꾸시는 기능은 준비하고 있어요.",
  ...
  },
  {
    ...
    sarg: function (s) {
      return {
        ...
        route: "전국 제휴 검진센터를 지역·항목·가격으로 비교해서 원하는 날짜에 잡아드릴게요 — 국가검진 항목에 추가 검사를 함께 받으실 수도 있어요.",
        guide: "그리고 " + free3Long(),   /* 3종 문안은 free3Def 단일 원천(F0) */
      };
    },
    preview: { route: "app://checkup/booking", nav: "checkup", title: "검진센터 예약", desc: "제휴 검진센터 비교 → 날짜 선택 → 예약 + 무료 3종 자동 적용" },
    followup: function () { return { type: "notify", inDays: 14, message: "국가검진 예약, 아직이시면 이번 주에 잡아두는 게 좋아요 — 연말엔 자리가 금방 차요." }; },
    chips: ["검진센터 찾아줘", "무료 3종이 뭐예요?", "알림 받기"],
  },
  {
  ...
  },
  {
    ...
    sarg: function (s) {
      return {
        ...
        route: "추이 비교 화면에서 연도별 수치를 나란히 볼 수 있고, 개선된 지표가 있으면 보험료 재산정(인하·가입확대 전용) 신청까지 이어져요.",
  ...
  },
  {
    ...
    sarg: function (s) {
      return {
        ...
        route: "① 보장 공백 분석으로 실손 외 보장도 함께 점검하고 ② 가입을 원하시면 치료비 준비 진단 화면에서 상담으로 이어드려요 — 가입 여부 결정은 충분히 비교하신 뒤에 하세요.",
  ...
  },
  {
    ...
    sarg: function (s) {
      return {
        ...
        route: "건강쇼핑에서 검진 결과 맞춤 상품을 사면 마진의 60%가 다시 적립되는 순환이라 가장 알뜰해요.",
