...
const HI_WANT_CHECKUP_FREE3 = "그리고 " + free3Long();   /* 3종 문안은 free3Def 단일 원천(F0) */
...
const HI_WANT_INTRO_FREE = "이용료는 없어요. 하이핀을 통해 검진을 예약하고 받으시면 " + free3Short() + "를 함께 드리고, 건강쇼핑에서는 마진의 50%를 적립금으로 돌려드려요.";
