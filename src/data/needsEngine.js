/* ══════════════ 니즈·재원 엔진(needsEngine.js) — 프로 운영체계 2단계 v1.4 축⓪ (P1 · 형 승인 2026-08-30) ══════════════
   ...
   ⚠️ 헌법:
     ...
     · §0-C 통계는 출처·연도 필수(NE_SRC) — status: 정합(공식 통계 직결) / 관례(업계 관용 근사·형 확정 2026-08-31 승인 — 론칭 후 공식 통계 연결 시 정합 승격).
...
const NE_SRC = {
  cancerDur:  { v: 12, unit: "개월", ko: "암 주 치료·요양 기간", src: "보건복지부·중앙암등록본부 국가암등록통계(2022 발표) 기반 관례", status: "관례" },
  cancerQuit: { v: 0.47, unit: "", ko: "암 경험자 직업 중단율", src: "국립암센터 암경험자 직장복귀 연구(2013) — 46.5% 관용 인용", status: "관례" },
  ...
  living:     { v: { "저": 180, "중": 290, "고": 430 }, unit: "만원/월", ko: "가구 월 생활비(소득 밴드별)", src: "통계청 가계동향조사(2024) 소비지출 근사 밴드", status: "관례" },
};
