...
/* 치료비 케어 적립금 — 적립되는 Health Token의 30%를 '치료비 케어 적립금'으로 우선 적립(보험료·의료비 결제 전용). 전 섹션 공통 적용 */
...
const NFT_USE = [
  { n: 1, t: "보험금 청구 자동 증빙", d: "보험금 청구 시 검진·진료 NFT가 자동 증빙으로 제출되어 서류 없이 간편 청구됩니다.", to: "insurance", chip: "치료비 케어" },
  ...
  { n: 5, t: "치료비 결제 즉시 증빙", d: "진료비 결제 영수 NFT가 보험금 청구·연말정산 의료비 증빙으로 바로 쓰입니다.", to: "insurance", chip: "치료비 케어" },
