...
/* ── 판매마진 분배(적립 50% · 나눔 10% · 운영 40%) ── */
const WALLET_SPLIT = { earn: 50, give: 10, ops: 40 }; // 판매마진 대비 %
const WALLET_GIVE = { cum: 32400000, month: 4800000, people: 128, my: 46200 }; // 누적·이번달 기부·수혜 인원·내 기여(예시, 원)
...
const WALLET_GIVE_FLOW = [
  ...
  { n: 2, t: "10% 나눔 준비금 자동 적립", d: "판매마진의 10%가 ‘치료비 나눔 준비금’으로 자동 적립됩니다 — 회원 추가 부담은 없습니다." },
