...
const WHITEPAPER = [
  {
    ...
    status: "draft", version: "v0.2", updated: "2026-07-05",
    ...
    body: [
      ...
      { t: "list", items: [
        ...
        "고령화발 의료비 폭증 — 초고령사회 진입에 따른 의료·돌봄 재정 압박.",
        "건강 형평성 격차 — 소득·지역·연령에 따른 건강관리 접근성 불균형.",
      ] },
      { t: "h", x: "1.3 의료비 사각지대" },
      { t: "p", x: "국민건강보험 **보장률은 60%대 중반** 수준으로, 비급여·간병·교통·소득상실 등을 포함한 실질 의료부담은 이보다 크다. 특히 중증·만성질환에서 치료비 공백이 가계 파탄으로 이어진다. 〔수치·출처 검증 진행 중〕" },
      { t: "h", x: "1.4 예방중심 의료체계" },
    ...
    sources: [
      { title: "건강보험 보장률(건강보험 보장성 강화 대책 관련 통계)", org: "국민건강보험공단", url: "", note: "정확 수치·연도 확인 필요(조사중)" },
      { title: "장래인구추계·고령인구 비중", org: "통계청 KOSIS", url: "", note: "초고령사회 진입 시점 인용 예정" },
      { title: "OECD Health Statistics — Out-of-pocket 지출", org: "OECD", url: "", note: "국제 비교 근거(조사중)" },
    ],
  },
