...
const WHITEPAPER = [
  ...
  },
  {
    ...
    summary: "초고령사회(세계 최단 7년)·노인 진료비 44%·실손 손해율 116%라는 '문제의 정점'과, AI 에이전트·마이데이터·AI 규제라는 '해법의 성숙'이 2020년대 중반 처음으로 수렴했다. 지금이 예방 중심 건강금융을 실현할 유일한 변곡점이다.",
    body: [
      ...
      { t: "h", x: "2.3 보험의 한계 — 사후·과잉 진료 구조의 임계점" },
      ...
      { t: "note", x: "공보험 보장률(65.7%)과 민영 실손이 **모두 사후치료에 집중**되면서, 예방·건강행동에 보상하는 설계가 비어 있다. 바로 여기에 HI-Fin의 기회가 있다 — **건강을 지킬수록 이득이 되는 구조**로의 전환." },
